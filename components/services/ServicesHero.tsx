...
export function ServicesHero() {
  return (
    <section className="relative flex min-h-svh flex-col overflow-hidden pt-24 pb-10 sm:pt-28 sm:pb-12 lg:min-h-[52rem] lg:pt-32 lg:pb-16">
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_78%_28%,rgb(11_125_255/0.12),transparent_34%),radial-gradient(circle_at_18%_78%,rgb(1_208_252/0.1),transparent_32%)]" />
