...
import { AUTH_PATHS, safeInternalPath } from "@/modules/auth";
...
export default async function LoginPage({
  ...
  const nextPath = safeInternalPath(nextParam, AUTH_PATHS.app);
  ...
  return (
    <main className="rounded-(--radius-panel) border border-white/70 bg-white/80 p-8 shadow-(--shadow-soft)">
      ...
      <p className="mt-3 text-[15px] leading-relaxed text-muted">
        Access the Flash One platform with your email and password.
      </p>
